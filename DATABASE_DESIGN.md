...
| 14 | `teaching_sessions` | บันทึกการสอนจริง | 13 | เก็บเวลาสอนจริง เนื้อหา และความก้าวหน้า | สร้างแล้ว |
| 15 | `attendances` | การเข้าเรียน | 7 | เก็บสถานะเข้าเรียนของสมาชิกแต่ละคนต่อครั้ง | สร้างแล้ว |
| 16 | `payments` | การชำระเงิน | 12 | เก็บยอด วิธีชำระ และสถานะตรวจสอบ | สร้างแล้ว |
| 17 | `payment_proofs` | หลักฐานการชำระเงิน | 12 | เก็บ Metadata ของสลิปและผลตรวจ | สร้างแล้ว |
| 18 | `receipts` | ใบเสร็จ | 9 | เก็บเลขและไฟล์ใบเสร็จของ Payment ที่ชำระแล้ว | สร้างแล้ว |
