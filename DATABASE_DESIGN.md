...
แบบปัจจุบันมี **20 ตาราง รวม 201 คอลัมน์ตามแผน**
...
| 3 | `parents` | ผู้ปกครอง | 11 | เก็บข้อมูลส่วนตัวและข้อมูลติดต่อผู้ปกครอง | รอสร้าง |
| 4 | `students` | นักเรียน | 11 | เก็บข้อมูลนักเรียนซึ่งอยู่ในความดูแลของผู้ปกครอง | รอสร้าง |
| 5 | `teachers` | ครู | 10 | เก็บโปรไฟล์ครูและเชื่อมบัญชี Login | รอสร้าง |
| 6 | `courses` | คอร์ส | 12 | เก็บข้อมูลแม่แบบคอร์ส ราคา และเวลารวม | รอสร้าง |
| 7 | `levels` | ระดับ | 7 | เก็บระดับความสามารถ แยกจากอายุและคอร์ส | รอสร้าง |
| 8 | `applications` | ใบสมัคร | 13 | เก็บข้อมูลผู้ปกครองที่กรอกใบสมัครก่อนมีบัญชี | รอสร้าง |
| 9 | `application_students` | นักเรียนในใบสมัคร | 15 | รองรับนักเรียนหลายคนในใบสมัครเดียว | รอสร้าง |
| 10 | `enrollments` | การลงทะเบียนเรียน | 13 | ยืนยันนักเรียน คอร์ส ระดับ เวลา และราคาที่ซื้อ | รอสร้าง |
| 11 | `classes` | คลาสเรียน | 11 | เก็บกลุ่มเรียนจริงของคอร์สและระดับ | รอสร้าง |
| 12 | `class_members` | สมาชิกคลาส | 8 | เชื่อม Enrollment เข้ากับ Class | รอสร้าง |
| 13 | `schedules` | ตารางเรียนรายครั้ง | 11 | เก็บวันและเวลาที่วางแผนสอนแต่ละครั้ง | รอสร้าง |
