...
- [ ] Admin เพิ่มครู
- [ ] Admin แก้ไขครู
- [ ] Admin เปิด/ปิดบัญชีครู
- [ ] Admin สร้างข้อมูล Login ครู
- [ ] Teacher ดู Profile ตนเอง
- [ ] ตรวจสิทธิ์ Teacher
...
- [ ] CRUD Course
- [ ] เปิด/ปิดรับสมัคร Course
- [ ] Promotion
- [ ] Level
- [ ] สร้าง Class
- [ ] กำหนด Course ให้ Class
- [ ] กำหนด Level
- [ ] กำหนด Teacher
- [ ] เพิ่ม Student เข้าคลาส
- [ ] ย้าย/นำ Student ออกจากคลาส
- [ ] ตรวจนักเรียนเรียนหลาย Course ได้
- [ ] ทดสอบ Postman
...
- [ ] เพิ่มตารางเรียนรายครั้ง
- [ ] แก้ไขตาราง
- [ ] เลื่อนตาราง
- [ ] ยกเลิกตาราง
- [ ] Teacher ดูตารางตนเอง
- [ ] Parent ดูตาราง Student
- [ ] ตรวจสิทธิ์
- [ ] ทดสอบกรณีเวลาไม่ถูกต้อง
- [ ] พิจารณาการตรวจตารางชนกัน
