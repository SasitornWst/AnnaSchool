...
- [x] Teacher เปิด Teaching Session
- [x] บันทึกเนื้อหาการสอน
- [x] บันทึก Attendance
- [x] บันทึกจำนวนชั่วโมง
- [x] บันทึกความก้าวหน้า
- [x] คำนวณ Used Hours
- [x] คำนวณ Remaining Hours
- [x] รองรับ 1.5 ชั่วโมง
- [x] ป้องกันชั่วโมงติดลบ
- [x] ป้องกันการหักซ้ำ
- [x] Parent ดูประวัติการเรียน
- [x] Parent ดูชั่วโมง
- [x] Admin ตรวจสอบ
- [x] ทดสอบ Postman ทุกกรณีสำคัญ

---

# Phase 12 — การชำระเงิน

- [x] สร้างรายการชำระเงิน
- [x] สถานะยังไม่ชำระ
- [x] Upload หลักฐาน
- [x] ตรวจชนิดไฟล์
- [x] ตรวจขนาดไฟล์
- [x] Admin ดูหลักฐาน
- [x] Admin ยืนยันชำระแล้ว
- [x] บันทึกเงินสด
- [x] รองรับ QR Payment ในระดับที่กำหนด
- [x] ทำข้อมูลใบเสร็จ
- [x] Parent ดู/ดาวน์โหลดหลักฐานหรือใบเสร็จ
- [x] ตรวจ Authorization ของไฟล์
